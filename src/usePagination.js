...
export const usePagination = ({
  ...
  siblingCount , //represents the min number of page buttons to be shown on each side of the current page button. Defaults to 1.
  pageSize, // represents the maximum data that is visible in a single page.
}) => {
  const rangeOfPagination = useMemo(() => {
    // Our implementing Logic-------
    ...
    /*
      We do not show dots just when there is just one page number
       to be inserted between the extremes of sibling and the page limits
        ...
        Hence we are using leftSiblingIndex > 2 and 
